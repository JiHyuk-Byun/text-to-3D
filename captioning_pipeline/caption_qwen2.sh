...
do 
    ...
    CUDA_VISIBLE_DEVICES=$gpu python3 caption_qwen2.py --batch_n $index --parent_dir ${in_dir} --model_type $model_type --n_view $n_view --single_pkl True --out_file $out_file
